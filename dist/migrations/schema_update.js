...
async function migrate() {
    try {
        ...
        await db_1.default.execute("ALTER TABLE exam_questions ADD COLUMN type ENUM('objective', 'theory') DEFAULT 'objective' AFTER exam_id");
...
migrate();
//# sourceMappingURL=schema_update.js.map